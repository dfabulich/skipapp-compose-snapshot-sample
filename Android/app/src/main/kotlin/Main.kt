...
internal val logger: SkipLogger = SkipLogger(subsystem = "my.app", category = "MyApp")

private typealias AppRootView = MyAppRootView
private typealias AppDelegate = MyAppAppDelegate
